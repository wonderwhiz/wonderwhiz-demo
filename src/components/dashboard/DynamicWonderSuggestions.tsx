...
const DynamicWonderSuggestions: React.FC<DynamicWonderSuggestionsProps> = ({
  ...
  const getCardStyle = (index: number) => {
    ...
    const baseStyles = "relative group p-6 rounded-2xl text-left transition-all duration-300 border border-white/20 backdrop-blur-lg shadow-lg hover:shadow-xl";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {suggestions.map((suggestion, index) => (
          ...
          >
            ...
            <p className={`${getFontSize()} font-medium text-white/95 relative z-10 font-nunito leading-relaxed`}>
              {suggestion}
            </p>
