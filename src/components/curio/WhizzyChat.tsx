...
const WhizzyChat: React.FC<WhizzyChatProps> = ({
  ...
  return (
    <div className="fixed bottom-0 right-0 w-full md:w-96 bg-gradient-to-br from-wonderwhiz-deep-purple to-wonderwhiz-purple shadow-2xl rounded-t-xl overflow-hidden border-t border-white/20 z-50">
        ...
        <CollapsibleTrigger asChild>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              {isOpen ? <ChevronDown className="h-4 w-4 text-white/70" /> : <ChevronUp className="h-4 w-4 text-white/70" />}
            </div>
          </motion.div>
        </CollapsibleTrigger>
