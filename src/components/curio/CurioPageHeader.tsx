...
import { PieChart, RefreshCcw, Sparkles } from 'lucide-react';
...
const CurioPageHeader: React.FC<CurioPageHeaderProps> = ({
  ...
  return (
    <motion.header 
      className="bg-gradient-to-b from-wonderwhiz-deep-purple to-indigo-950/95 backdrop-blur-md py-4 border-b border-white/10 shadow-md"
