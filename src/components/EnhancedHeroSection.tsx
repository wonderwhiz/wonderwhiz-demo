    ...
    <section className="pt-10 pb-20 px-6 md:px-10 lg:px-20">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedTooltip
              content={
                <div className="max-w-xs">
                  <p className="font-bold text-wonderwhiz-pink">Curiosity is the key to learning!</p>
                  <p className="text-sm mt-1">Children who explore their interests develop stronger neural connections.</p>
                </div>
              }
              delay={300}
            >
              <span className="inline-block">The discovery engine that</span>
            </AnimatedTooltip>
            <span className="text-wonderwhiz-pink relative ml-2">
        ...
        <motion.div 
          ...
          className="relative"
        >
          <TiltCard className="mx-auto max-w-[350px]">
