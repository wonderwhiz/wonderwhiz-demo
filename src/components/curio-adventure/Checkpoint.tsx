          ...
          {data.options.map((opt, i) => {
            ...
            return (
              <button
                ...
                className={[
                  'w-full text-left px-4 py-4 rounded-2xl border-2 text-base font-bold transition min-h-[56px] flex items-center gap-3',
                  state === 'idle' && 'border-border bg-surface-tertiary text-text-primary hover:border-accent-brand hover:-translate-y-0.5',
