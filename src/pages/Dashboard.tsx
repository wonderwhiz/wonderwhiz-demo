              ...
              <div className="my-4 sm:my-6 relative">
                ...
                <MagicalBorder active={true} type="rainbow" className="rounded-2xl overflow-hidden shadow-lg">
                  ...
                  handleSubmitQuery();
                    ...
                    <Input placeholder={isMobile ? "Ask me anything!" : "What do you want to explore today? Ask me anything!"} value={query} onChange={e => setQuery(e.target.value)} className="px-6 py-6 sm:py-8 bg-white/10 border-white/20 text-white text-base sm:text-lg placeholder:text-white/60 placeholder:text-center focus:ring-2 focus:ring-wonderwhiz-gold/50 focus:border-wonderwhiz-gold" disabled={isGenerating} />
